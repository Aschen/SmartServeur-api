...
class ProduitsControllerTest < ActionController::TestCase
  ...
  test "should create produit" do
    assert_difference('Produit.count') do
      post :create, produit: { categorie_id: @produit.categorie_id, description: @produit.description, image: @produit.image, nom: @produit.nom, prix: @produit.prix }
    end
  ...
  test "should update produit" do
    patch :update, id: @produit, produit: { categorie_id: @produit.categorie_id, description: @produit.description, image: @produit.image, nom: @produit.nom, prix: @produit.prix }
    assert_redirected_to produit_path(assigns(:produit))
  end
